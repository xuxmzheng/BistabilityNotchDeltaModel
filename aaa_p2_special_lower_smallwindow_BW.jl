...
begin
    ...
    # Thick black vertical lines separating the S | SR | RR regions
    CairoMakie.vlines!(ax, [663.0, 676.5]; color = :black, linewidth = 5)
    ...
    display(fig)
    save("bifurcation_special_p2_lower_BW.png", fig)
end
