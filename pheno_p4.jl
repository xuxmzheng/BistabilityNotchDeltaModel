...
# --- 4. Plotting (LARGE LEGEND OVERLAP) ---
begin
    fig = Figure(size = (1000, 800), fontsize = 30, figure_padding = (15, 40, 15, 15))
    ...
    # Legend Overlap with LARGER fonts
    Legend(fig, elements, labels, "Phenotype",
           labelsize = 28,           # Increased from 18
           titlesize = 32,           # Increased from 22
           patchsize = (40, 40),     # Increased box sizes for visibility
    ...
    # Removes extra whitespace around the figure
    resize_to_layout!(fig)

    display(fig)
    save("pheno_p4.png", fig)
    println("Saved as pheno.png")
end