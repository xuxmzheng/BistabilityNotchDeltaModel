...
begin
    ...
    text!(ax, 656, text_y, text = "R", fontsize = 40, align = (:center, :center), color = :black)
    # Shifted RR label slightly to the left to avoid legend overlap
    text!(ax, 675.0, text_y, text = "RR", fontsize = 40, align = (:center, :center), color = :black)
    ...
    CairoMakie.scatter!(ax, [651], [920], color = :black, markersize = 50, marker = :circle)
